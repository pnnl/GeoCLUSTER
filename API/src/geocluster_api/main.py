...
def run_sbt_simulation(body: SBTPayload, sbt_version=Literal[1, 2]):
    ...
    try:
        times, Tout, Pout = run_sbt(
            ...
            Diameter1=sbt_params.well_bore_radius_vertical * 2,  # Convert radius to diameter
            Diameter2=sbt_params.well_bore_radius_horizontal * 2,  # Convert radius to diameter
