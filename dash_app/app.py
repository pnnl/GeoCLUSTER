...
from text import *
from unit_conversions import convert_value, get_unit_symbol, unit_converter
from unit_preferences import (
    apply_imperial_units,
    apply_metric_units,
    create_unit_preferences_card,
    get_unit_preferences_from_inputs,
)
        ...
        try:
            ...
            try:
                ...
                return dcc.send_data_frame(
                    main_df.to_excel, filename="geoCLUSTER_results.xlsx", index=False
                )
        ...
        if tab == "about-tab":
            ...
            if visibility_state:
                ...
                if "Horizontal Extent" in visibility_state:
                    ...
                    return n, b, b, b, b, n, b, n, n, n, n, n, b
...
def update_slider_ranges(model, case, unit_system):
    ...
    if model == "HDF5":
        ...
        if unit_system == "imperial":
            Tsurf_container = create_enhanced_slider(
                DivID="Tsurf-select-div",
                ID="Tsurf-select",
                ptitle="Surface Temperature (°F)",
                min_v=32,
                max_v=104,
                mark_dict={32: "32", 104: "104"},
                start_v=77,
                div_style=div_none_style,
                parameter_name="Surface Temperature (˚F)",
            )
            grad_container = create_enhanced_slider(
                DivID="grad-select-div",
                ID="grad-select",
                ptitle="Geothermal Gradient (°F/ft)",
                min_v=0.0082,
                max_v=0.0546,
                mark_dict={0.0082: "0.008", 0.0546: "0.055"},
                start_v=0.0328,
                div_style=div_block_style,
                parameter_name="Geothermal Gradient (˚F/ft)",
            )
            k_container = create_enhanced_slider(
                DivID="k-select-div",
                ID="k-select",
                ptitle="Rock Thermal Conductivity (Btu/ft-h-°F)",
                min_v=0.231,
                max_v=2.89,
                mark_dict={0.231: "0.2", 2.89: "2.9"},
                start_v=1.73,
                div_style=div_block_style,
                parameter_name="Rock Thermal Conductivity (Btu/ft-h-˚F)",
            )
            Tinj_container = create_enhanced_slider(
                DivID="Tinj-select-div",
                ID="Tinj-select",
                ptitle="Injection Temperature (°F)",
                min_v=86,
                max_v=140,
                mark_dict={86: "86", 140: "140"},
                start_v=86,
                div_style=div_block_style,
                parameter_name="Injection Temperature (˚F)",
            )
            mdot_container = create_enhanced_slider(
                DivID="mdot-select-div",
                ID="mdot-select",
                ptitle="Mass Flow Rate (lb/s)",
                min_v=0.066,
                max_v=154,
                mark_dict={0.066: "0.07", 154: "154"},
                start_v=53,
                div_style=div_block_style,
                parameter_name="Mass Flow Rate (lb/s)",
            )
            diameter_container = create_enhanced_slider(
                DivID="diameter-select-div",
                ID="diameter-select",
                ptitle="Borehole Diameter (ft)",
                min_v=0.708,
                max_v=1.458,
                ...
                start_v=1.15,
                div_style=div_block_style,
                parameter_name="Borehole Diameter (ft)",
            )
            L2_container = create_enhanced_slider(
                DivID="L2-select-div",
                ID="L2-select",
                ptitle="Horizontal Extent (ft)",
                min_v=708,
                max_v=65617,
                mark_dict={708: "708", 65617: "65k"},
                start_v=32808,
                div_style=div_block_style,
                parameter_name="Horizontal Extent (ft)",
            )
            L1_container = create_enhanced_slider(
                DivID="L1-select-div",
                ID="L1-select",
                ptitle="Drilling Depth (ft)",
                min_v=3281,
                max_v=26247,
                mark_dict={3281: "3.3k", 26247: "26k"},
                start_v=11483,
                div_style=div_block_style,
                parameter_name="Drilling Depth (ft)",
            )
        else:
            # Metric HDF5 ranges
            Tsurf_container = create_enhanced_slider(
                DivID="Tsurf-select-div",
                ID="Tsurf-select",
                ptitle="Surface Temperature (°C)",
                min_v=0,
                max_v=40,
                mark_dict={0: "0", 40: "40"},
                start_v=25,
                div_style=div_none_style,
                parameter_name="Surface Temperature (˚C)",
            )
            grad_container = create_enhanced_slider(
                DivID="grad-select-div",
                ID="grad-select",
        ...
        if unit_system == "imperial":
            ...
            mdot_container = create_enhanced_slider(
                ...
                start_v=13.2,
                div_style=div_block_style,
                parameter_name="CovHDF5 Mass Flow Rate (lb/s)",
            )
            L2_container = create_enhanced_slider(
                DivID="L2-select-div",
                ID="L2-select",
                ...
                start_v=32808,
                div_style=div_block_style,
                parameter_name="CovHDF5 Horizontal Extent (ft)",
            )
            L1_container = create_enhanced_slider(
                DivID="L1-select-div",
                ID="L1-select",
                ...
                start_v=11483,
                div_style=div_block_style,
                parameter_name="CovHDF5 Drilling Depth (ft)",
            )
            grad_container = create_enhanced_slider(
                DivID="grad-select-div",
                ID="grad-select",
                ...
                start_v=0.0328,
                div_style=div_block_style,
                parameter_name="CovHDF5 Geothermal Gradient (°F/ft)",
            )
            perm_container = create_enhanced_slider(
                DivID="diameter-select-div",
                ID="diameter-select",
                ptitle="Permeability (HWR)",
                min_v=0.1,
                max_v=1.0,
                mark_dict={0.1: "0.1", 0.5: "0.5", 0.999: "1.0"},
                start_v=0.5,
                div_style=div_block_style,
                parameter_name="Permeability (HWR)",
            )
            Tinj_container = create_enhanced_slider(
                DivID="Tinj-select-div",
                ID="Tinj-select",
                ...
                start_v=86,
                div_style=div_block_style,
                parameter_name="CovHDF5 Injection Temperature (°F)",
            )
        else:
            ...
            mdot_container = create_enhanced_slider(
                ...
                start_v=6,
                div_style=div_block_style,
                parameter_name="CovHDF5 Mass Flow Rate (kg/s)",
            )
            L2_container = create_enhanced_slider(
                DivID="L2-select-div",
                ID="L2-select",
                ...
                start_v=2500,
                div_style=div_block_style,
                parameter_name="CovHDF5 Horizontal Extent (m)",
            )
            L1_container = create_enhanced_slider(
                DivID="L1-select-div",
                ID="L1-select",
                ...
                start_v=3500,
                div_style=div_block_style,
                parameter_name="CovHDF5 Drilling Depth (m)",
            )
            grad_container = create_enhanced_slider(
                DivID="grad-select-div",
                ID="grad-select",
                ...
                start_v=0.06,
                div_style=div_block_style,
                parameter_name="CovHDF5 Geothermal Gradient (K/m)",
            )
            perm_container = create_enhanced_slider(
                DivID="diameter-select-div",
                ID="diameter-select",
            ...
            Tinj_container = create_enhanced_slider(
                ...
                start_v=30,
                div_style=div_block_style,
                parameter_name="CovHDF5 Injection Temperature (°C)",
            )
...
def update_sliders_hyperparms(model):
    if model == "SBT V1.0":
        hyperparam1 = create_enhanced_dropdown(
        ...
        hyperparam3 = create_enhanced_dropdown(
        ...
        hyperparam5 = create_enhanced_dropdown(
            ...
            disabled=True,
            div_style=div_none_style,
            parameter_name="Fluid Properties Mode",
        )
        ...
        hyperparam1 = create_enhanced_slider(
            DivID="mass-flow-mode-div",
            ID="mass-mode-select",
        ...
        hyperparam3 = create_enhanced_slider(
            DivID="temp-flow-mode-div",
            ID="temp-mode-select",
...
def update_subsurface_contours_plots(
    interp_time, fluid, case, param, mdot, L2, L1, grad, D, Tinj, k_m, units
):
    # -----------------------------------------------------------------------------
...
@app.callback(
    ...
    [
        ...
        Input(component_id="model-select", component_property="value"),
        Input(
            component_id="quick-unit-selector", component_property="value"
        ),  # Add this input
    ...
    try:
        economics_fig, econ_data_dict, econ_values_dict, err_econ_dict = (
            generate_econ_lineplots(
                ...
                D_metric,
                Tinj_metric,
                k_metric,  # Use metric values
                Drilling_cost_per_m_metric,
                Discount_rate,
                Lifetime,  # Use metric drilling cost
                Direct_use_heat_cost_per_kWth,
                Power_plant_cost_per_kWe,
                Pre_Cooling_Delta_T_metric,
                Turbine_outlet_pressure,  # Use metric pre-cooling
                scale,
...
def update_table(
    ...
    if units == "imperial":
        ...
        c_j_kg_k = (
            c_m * 4186.8 if c_m is not None else 4186.8
        )  # BTU/(lb·°F) to J/(kg·K)
