...
times, Tout, Pout = run_sbt_final(
        ...
        HYPERPARAM3=0, # variablefluidproperties -- constant fluid properties or 1 variable -- done
...
print("Time Steps: ", len(times)) # 175 time steps (in seconds)
print("Tout: ", Tout[-1]-272.15) # last value (in Kelvin converted to Celcius)
print("Pout: ", Pout[-1]/1e6) # should be None, later in clgs.py set to 20 MPa constant in Pa
end = time.time()
